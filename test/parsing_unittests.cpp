...
TEST_CASE("test wrong parser") {
    ...
    REQUIRE_THROWS(parse_scp_instance("../instances/src/main.cpp"));
    REQUIRE_THROWS(parse_rail_instance("../instances/src/main.cpp"));
    REQUIRE_THROWS(parse_cvrp_instance("../instances/src/main.cpp"));
    REQUIRE_THROWS(parse_mps_instance("../instances/src/main.cpp"));
}
...
TEST_CASE("parse_inst_and_initsol") {

    SECTION("Parsing SCP instance") {
        auto sol = Solution();
        sol.cost = 429.0_F;
        sol.idxs = std::vector<cidx_t>{
            2_C,  47_C,  121_C, 432_C, 42_C,  0_C,   80_C,  145_C, 88_C,  90_C,  27_C,
            9_C,  69_C,  11_C,  1_C,   152_C, 274_C, 123_C, 137_C, 16_C,  65_C,  43_C,
            77_C, 76_C,  53_C,  143_C, 24_C,  193_C, 10_C,  46_C,  106_C, 17_C,  7_C,
            62_C, 82_C,  45_C,  14_C,  74_C,  19_C,  49_C,  5_C,   20_C,  28_C,  22_C,
            4_C,  120_C, 102_C, 21_C,  51_C,  25_C,  84_C,  12_C,  68_C,  48_C,  13_C,
            8_C,  115_C, 58_C,  85_C,  57_C,  119_C, 15_C,  70_C,  93_C,  142_C, 109_C};
    ...
    SECTION("Parsing RAIL instance") {

        auto sol = Solution();
        sol.cost = 174.0_F;
        sol.idxs = std::vector<cidx_t>{
            610_C,   38909_C, 12694_C, 18537_C, 12495_C, 45716_C, 12391_C, 3041_C,  33082_C,
            56641_C, 581_C,   39708_C, 6595_C,  42314_C, 9261_C,  27079_C, 15198_C, 62403_C,
            42657_C, 57117_C, 56703_C, 41195_C, 55674_C, 20667_C, 19939_C, 6882_C,  6859_C,
            20668_C, 7279_C,  6229_C,  20646_C, 246_C,   33189_C, 17876_C, 12129_C, 43867_C,
            11958_C, 245_C,   56964_C, 47176_C, 55671_C, 10683_C, 11593_C, 49227_C, 3457_C,
            5890_C,  10349_C, 25973_C, 48276_C, 60232_C, 61649_C, 56143_C, 2063_C,  9963_C,
            56892_C, 57149_C, 3953_C,  9297_C,  33130_C, 14451_C, 5234_C,  48476_C, 38220_C,
            52534_C, 30826_C, 48922_C, 40632_C, 3154_C,  45479_C, 54870_C, 11020_C, 53275_C,
            23838_C, 55759_C, 18535_C, 15869_C, 14226_C, 47884_C, 38069_C, 3172_C,  62370_C,
            2947_C,  49385_C, 40832_C, 11396_C, 36867_C, 2325_C,  49405_C, 7878_C,  44976_C,
            1971_C,  3258_C,  7802_C,  38381_C, 13297_C, 7556_C,  11194_C, 41084_C, 1392_C,
            57163_C, 38516_C, 33610_C, 57556_C, 1252_C,  351_C,   13211_C, 44684_C, 42200_C,
            62293_C, 41743_C, 17051_C, 11968_C, 41267_C, 50918_C};
        auto env         = cft::Environment();
    ...
    SECTION("Invalid parser") {
        auto env         = cft::Environment();
        env.initsol_path = "./instance.txt";
        env.parser       = "INVALID";
        env.inst_path    = "./solution.txt";
        REQUIRE_THROWS_AS(parse_inst_and_initsol(env), std::runtime_error);
    }
}
